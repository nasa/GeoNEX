...
Most of the GeoNEXTools functions are compatible with [MODISTools](https://github.com/ropensci/MODISTools) for ease to users who are familiar with [MODISTools](https://github.com/ropensci/MODISTools).
